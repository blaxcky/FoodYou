...
class StepExclusionMigrationTest : AbstractStepExclusionMigrationTest() {
    private val instrumentation = InstrumentationRegistry.getInstrumentation()
    private val file = instrumentation.targetContext.getDatabasePath("StepExclusionMigrationTest.db")
