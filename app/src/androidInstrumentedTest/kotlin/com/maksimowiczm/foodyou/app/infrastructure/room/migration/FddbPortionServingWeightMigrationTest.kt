...
class FddbPortionServingWeightMigrationTest : AbstractFddbPortionServingWeightMigrationTest() {
    private val instrumentation = InstrumentationRegistry.getInstrumentation()
    private val file =
        instrumentation.targetContext.getDatabasePath("FddbPortionServingWeightMigrationTest.db")
